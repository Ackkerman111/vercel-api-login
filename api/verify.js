...
export default async function handler(req, res) {
    ...
    if (now > expires) {
        return res.json({ status: false, reason: "Key expired. Please generate a new one." });
    }
    ...
    // Device already bound and matches
    ...
    return res.json({ status: false, reason: "Key already bound to another device." });
}